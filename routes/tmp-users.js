...
router.get("/admin/reservations", requireAuth, requireAdmin, TmpUserController.getAllReservations);
router.put("/admin/reservations/:id/status", requireAuth, requireAdmin, TmpUserController.updateReservationStatus);
router.get("/admin/filter-options", requireAuth, requireAdmin, TmpUserController.getFilterOptions);
