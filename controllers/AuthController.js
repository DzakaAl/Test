...
class AuthController {
  ...
  static async getAllUsersWithReservations(req, res) {
    try {
      ...
      const reservations = await User.getAllReservationsWithUserData(filters);
  ...
  static async updateReservationStatus(req, res) {
    try {
      ...
      const result = await User.updateReservationStatus(reservasiId, status, keterangan);
  ...
  static async updatePaymentStatus(req, res) {
    try {
      ...
      const result = await User.updatePaymentStatus(paymentId, status, keterangan);
